...
*Diagram Translation (Mapping Rational Numbers to Lattice Points):*
- **Vertical Axis**: Numerator (positive integers)
- **Horizontal Axis**: Denominator (non-zero integers)
- **Trace Pattern**: Starting at $1/1$ (START), trace zigzag path. Count irreducible fractions ($\circ$) to prove rational numbers are **countable**.
...
*Diagram Translation (The Complex Plane):*
...
*Diagram Translation (Multiplication by $i$ as $90^\circ$ Rotation):*
